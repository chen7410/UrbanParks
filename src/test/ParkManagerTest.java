...
public class ParkManagerTest {
	...
	public void setUp() throws Exception {
		...
		myJobTakesOneDayLessThanMax = new Job(myJobOneLessDayStartDate, myJobOneLessDayEndDate, "Cal Anderson", myPM, "Seattle, WA");
		...
		myJobTakesExactlyMaxDays = new Job(myJobExactlyMaxStartDate, myJobExactlyMaxEndDate, "Gas Works Park", myPM, "Seattle, WA");
		...
		myJobTakesOneDayMoreThanMax = new Job(myJobOneMoreDayStartDate, myJobOneMoreDayEndDate, "Volunteer Park", myPM, "Seattle, WA");
	}
